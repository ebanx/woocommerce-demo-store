...
function load_assets() {
  ...
  wp_enqueue_style( 'subscriptions', get_stylesheet_directory_uri() . '/css/subscriptions.css' );
...
/* Images Size */
add_image_size('product-thumb', 345, 325, true);
add_image_size('product-gallery', 640, 605, true);
add_image_size('product-gallery-thumb', 90, 50, true);
