...
<div class="wrap about-wrap product-activation-wrap">
			...
			<div class="laborator-about-row">
				<div class="col col-12">
					<div class="license-detail">
						Licensed domain:
						<strong><?php echo $license->domain; ?></strong>
					</div>
					...
					<div class="license-detail">
						Support status
						<strong>
						<?php Kalium_Theme_License::nearlyExpiring(); if ( $license->support_expired ) : ?>
						...
						<?php else : $supported_until_time = strtotime( $license->supported_until ); ?>
							...
							<?php if ( Kalium_Theme_License::nearlyExpiring() ) : ?>
							<br>
							<span class="before-expiration">
								<i class="dashicons dashicons-warning"></i> 
								Your support package will expire soon, <a href="https://themeforest.net/item/kalium-creative-theme-for-professionals/10860525?ref=Laborator" target="_blank">renew support</a> with 30% discount before it expires
							</span>
							<?php endif; ?>
						<?php endif; ?>
						</strong>
	...
	<div class="about-description">
		You are almost done, activate the theme to get support, patches and latest updates including premium plugins bundled with this theme. <br>
