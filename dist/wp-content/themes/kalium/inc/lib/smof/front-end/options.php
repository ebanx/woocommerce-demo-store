	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="header">
			...
			<div class="logo">
				<h2>
					<?php echo THEMENAME; ?>
					<a href="<?php echo 'http://laborator.co/theme-version-check.php?theme=' . basename( get_template_directory_uri() ) . '&version=' . kalium()->getVersion() . '&ts=' . time() . '&TB_iframe=true'; ?>" title="Check for theme updates" class="theme_version thickbox"><?php echo kalium()->getVersion(); ?></a>
				</h2>
