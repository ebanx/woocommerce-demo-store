...
<code style='font-size: 10px; display: inline-block; margin-top: 10px;'>[lab_social_networks rounded colored=\"hover\"]</code> – Rounded icons and colored on hover,
<code style='font-size: 10px; display: inline-block; margin-top: 10px;'>[lab_social_networks colored-bg]</code> – Colored background <br>
<code style='font-size: 10px; display: inline-block; margin-top: 10px;'>[lab_social_networks colored-bg=\"hover\"]</code> – Colored background on hover";
...
$of_options[] = array(	'name' 		=> 'Brand Logo',
						'desc' 		=> "Upload your brand logo<br><small>{$note_str} If you want to upload SVG logo, install <a href=\"https://wordpress.org/plugins/svg-support/\" target=\"_blank\">SVG Support plugin</a>.</small>",
...
$of_options[] = array( 	'name' 		=> "Portfolio Title & Description",
						'desc' 		=> "Show header title and description in portfolio page. <br /><small>{$note_str} You can override this setting for individual portfolio pages.</small>",
...
$of_options[] = array( 	'desc' 		=> "Masonry Layout Mode<br /><small>{$note_str} When <strong>Masonry Mode</strong> is activated you can choose layout renderer.</small>",
...
$of_options[] = array( 	'desc' 		=> "Catalog thumbnail size<br /><small>{$note_str} You can choose between size variants you wont to show as item thumbnail.</small>",
...
$of_options[] = array( 	'desc' 		=> "Product Image Size<br /><small>{$note_str} Default WooCommerce image dimensions will be applied until you choose different image size.</small>",
...
$of_options[] = array( 	'desc' 		=> "Share Product Networks<br><small>{$note_str} Select social networks that you allow users to share the products of your shop</small>",
...
{					
	...
	$of_options[] = array( 	'name' 		=> 'Image Dimensions Info',
							...
							<p>
								...
								{$note_str} After changing image dimensions (or importing demo shop content) you may need to <a href=\"http://wordpress.org/extend/plugins/regenerate-thumbnails/\" target=\"_blank\">regenerate your thumbnails</a>.
							</p>
...
$of_options[] = array(  'name'		=> 'Advanced Custom Fields',
						'desc'   	=> 'Enable ACF Custom Fields management',
						'id'   		=> 'kalium_acf_advanced',
						'std'   	=> 0,
						'type'   	=> 'checkbox',
...
$typolab_warning = "<h3 style=\"margin: 0 0 10px;\">Deprecated:</h3>
						This feature is deprecated and will be removed in future updates of Kalium. 
						<br>
						<br>
						Please use <strong>TypoLab</strong> as our new tool that provides intuitive font integration interface with font sizes management and 5 font sources: <strong>Google</strong>, <strong>Font Squirrel</strong>, <strong>TypeKit</strong>, <strong>Premium Fonts</strong> and <strong>Custom Fonts</strong>
						<br>
						<br>
						<a href=\"admin.php?page=typolab\" class=\"button\">Go to TypoLab Fonts</a>";

$of_options[] = array( 	'name' 		=> 'TypoLab Fonts',
						'desc' 		=> '',
						'id' 		=> 'typolab_warning',
						'std' 		=> $typolab_warning,
						'icon' 		=> true,
...
$of_options[] = array( 	'name' 		=> 'Custom Fonts',
						...
						<h3 style=\"margin: 0 0 10px;\">Warning</h3>
...
$of_options[] = array( 	'name' 		=> 'Custom Fonts',
						...
						<br>
						<hr>
						<h3 style=\"margin: 0 0 10px;\">Including Custom Web Fonts</h3>
