...
function of_style_only(){
	...
	wp_enqueue_style('laborator-style', ADMIN_DIR . 'assets/css/laborator-smof.css', null, kalium()->getVersion());
...
function of_load_only()
{
	...
	wp_enqueue_script('smof', ADMIN_DIR .'assets/js/smof.js', array( 'jquery' ), kalium()->getVersion());
