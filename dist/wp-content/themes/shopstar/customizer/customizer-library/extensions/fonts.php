...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'shopstar' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'shopstar' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'shopstar' ),
		'cyrillic'     => __( 'Cyrillic', 'shopstar' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'shopstar' ),
		'devanagari'   => __( 'Devanagari', 'shopstar' ),
		'greek'        => __( 'Greek', 'shopstar' ),
		'greek-ext'    => __( 'Greek Extended', 'shopstar' ),
		'khmer'        => __( 'Khmer', 'shopstar' ),
		'latin'        => __( 'Latin', 'shopstar' ),
		'latin-ext'    => __( 'Latin Extended', 'shopstar' ),
		'vietnamese'   => __( 'Vietnamese', 'shopstar' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'shopstar' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'shopstar' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'shopstar' ),
